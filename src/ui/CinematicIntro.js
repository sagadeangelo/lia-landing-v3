    ...
    return /* html */ `
      ...
      <script>
        (function() {
          ...
          if (!introNode || !videoNode) return;

          // Prevenir scroll mientras corre la intro
          ...
          const endIntro = () => {
            ...
            // Remover nodo del DOM tras transición para liberar memoria
            setTimeout(() => {
          ...
          videoNode.addEventListener('error', endIntro); // Si falla, quitarlo
